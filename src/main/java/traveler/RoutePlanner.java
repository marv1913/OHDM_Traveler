...
public class RoutePlanner {
    ...
    public HashMap<String, String> planRoute(SearchRequestDAO searchRequestDAO, String requestID) throws FileNotFoundException, SQLException {
        ...
        RoutingMech routingMech = new RoutingMech(ohdmParameter.getSchema(), searchParameter, area, requestID, ohdmParameter.getRenderingSchema());
        ...
        String geometriesAsJSON = routingMech.getGeometriesFromResultWayTableAsJSON(sqlStatement);

        HashMap<String, String> results = new HashMap<>();
        results.put("total", RoutingMech.getFull_time());
        results.put("geometries", geometriesAsJSON);
